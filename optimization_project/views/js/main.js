...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // change size of all the elements with class randompizzacontainer directly instead of going to determineDx and doing the complicated stuff
    for (var i = 0; i < random.length; i++) {
     random[i].style.width=newsize*100+"%";
    }
  }
...
// calculating the values of phases andstoring them in a rray to avoid forced Synchronous layout
// remove i%5 and make the loop run only 5 times as phases array has only 5 diffrent values
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //Reducing the number of pizzas shows no effect in usage, but gives a great boost to performance
  for (var i = 0; i < 25; i++) {
